...
/*
pointcoind is a full-node bitcoin implementation written in Go.

The default options are sane for most users.  This means pointcoind will work 'out of
...
parsed when pointcoind starts up.  By default, the configuration file is located at
~/.pointcoind/pointcoind.conf on POSIX-style operating systems and %LOCALAPPDATA%\pointcoind\pointcoind.conf
